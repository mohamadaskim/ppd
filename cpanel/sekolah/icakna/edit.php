...
<option value="akp" >AKP</option>
                        ...
                        <div class="col-12">
                            ...
                            <input type="mula" class="form-control" value="<?= $d['notiket'] ?>" name="mula">
                        </div>
                    ...
                    <a href="/ppdkluang/cpanel/sekolah/ict/<?php echo $view.$page; ?>"  ><button type="button" class="btn btn-back btn-secondary"><i class="fa fa-undo" aria-hidden="true"></i> BATAL</button></a>    
