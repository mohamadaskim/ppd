                ...
                <td class="text-left align-middle"><span class="text-info font-weight-bold"><?=  $kewpa; ?></span><?php  if($sahkan!='') { ?><br><small class="text-info ">Disahkan Oleh <?=  $sahkan; ?></small> <?php } ?>
                        ...
                        <a style="display: inline;" href="/ppdkluang/cpanel/sekolah/ict/edit.php?id=<?=  $id; ?>&view=<?=  $urla; ?>&page=<?=  $page; ?>" class="buang btn btn-block btn-sm btn-success"><i class="fa fa-pencil" aria-hidden="true"></i></a>
