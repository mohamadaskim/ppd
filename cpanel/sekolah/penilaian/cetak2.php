...
$pdf->Cell(171,5,'BORANG PRETASI BULANAN',0,0,'C');
$pdf->Cell(20,5,'',0,1);

$pdf->SetFont('Times','B',12);
$pdf->Cell(10,5,'',0,0);
$pdf->Cell(170,5,'PERKHIDMATAN KAWALAN KESELAMATAN',0,1,'C');
$pdf->Ln(3);
...
$x=0;
$kanan=$pdf->GetY();
$kuri = $PPD->prepare("SELECT * FROM `penilaian_perkara` where kategori = 2 and kat_tajuk!='Lain-Lain' group by kat_tajuk");
$kuri->execute([]);
...
$dat=$s['kat_tajuk'];
$kurisub = $PPD->prepare("SELECT *,SUBSTR(ulasan,1,20) ulasan2 FROM `penilaian_perkara` p inner join penilaian_data d on d.perkara_id=p.ID where kategori = 2 and kat_tajuk='$dat' and d.kodsekolah=? and d.data_id=?");
...
//$pdf->Cell(18,5,'',1,0,'C');
//$pdf->Cell(30,5,'',1,1,'C');
$pdf->Cell(75,10,'PERATUS = (JUMLAH KESELURUHAN/80)*100',1,0,'C');
$pdf->Cell(17,10,$jumlah,1,0,'C');
$peratus=intval(($jumlah/80)*100);
...
$pdf->Cell(55,5,'1. Kes kehilangan Aset Kerajaan:',0,1,'L');
$pdf->Cell(140,5,'',0,0,'C');
$pdf->Cell(5,5,'',0,0,'C');
...
$pdf->Cell(140,5,'',0,0,'C');
$pdf->Cell(55,5,'2. Kes Salahlaku Oleh Pengawal :',0,1,'L');
$pdf->Cell(140,5,'',0,0,'C');
$pdf->Cell(5,5,'',0,0,'C');
$pdf->Cell(10,5,'Ada',0,0,'L');
$pdf->Cell(10,5,$n33,1,1,'C');
...
$pdf->Cell(140,5,'',0,0,'C');
$pdf->Cell(55,5,'3. Kes Pencerobohan / Polis :',0,1,'L');
$pdf->Cell(140,5,'',0,0,'C');
$pdf->Cell(5,5,'',0,0,'C');
$pdf->Cell(10,5,'Ada',0,0,'L');
$pdf->Cell(10,5,$n33,1,1,'C');
...
$pdf->Cell(140,5,'',0,0,'C');
$pdf->Cell(55,5,'4. Cadangan Pihak Sekolah : ',0,1,'L');
$pdf->Cell(140,5,'',0,0,'C');
$pdf->Cell(2,5,'',0,0,'C');
$pdf->Cell(36,5,'4.1 Perkhidmatan Diteruskan',0,0,'L');
$pdf->Cell(10,5,$n34,1,1,'C');
$pdf->Cell(140,5,'',0,0,'C');
$pdf->Cell(2,5,'',0,0,'C');
$pdf->Cell(36,5,'4.2 Perkhidmatan Ditamatkan      ',0,0,'L');
