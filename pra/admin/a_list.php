...
<body>
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i>Senarai</h3>
        <!-- SIMPLE TO DO LIST -->
          ...
          <div class="col-md-12">
            <section class="task-panel tasks-widget">
              <div class="panel-heading">
                <div class="pull-left">
                  <h5><i class="fa fa-tasks"></i>Senarai Sekolah</h5>
                </div>
                <br>
              </div>
 ...
 <?php 
$totalrow = mysqli_query($con,"SELECT * FROM `murid`");
$totalrow1=mysqli_num_rows($totalrow);

$totalshow=25;
$totalpage=ceil($totalrow1/$totalshow);
if(isset($_GET['page'])) {
    $page=$_GET['page'];
    $startshow=0;
    for($a=1;$a<$page;$a++){
    $startshow=$startshow+$totalshow;
    }
...
$a_mohons = mysqli_query($con,"SELECT * FROM `murid`  limit $startshow,$totalshow ");
              ...
              ?>
                    ...
                    <li>
                      ...
                      <div class="task-title">
                        <span class="task-title-sp"><?php echo $a_show['no_kp']; ?> - <?php echo $a_show['nama']; ?></span>

                          <span class="badge bg-warning"><?php echo $a_show['KODSEKOLAH']; ?></span>
...
?>
                  <a class="btn btn-default btn-sm pull-right" href="a_list.php?page=<?php echo $totalpage; ?>">Last</a>
<?php 
}
?>
...
for($a=6;$a>=1;$a--){
    ...
    if(($a+$pagex)<=$totalpage){
    ?>
                  <a class="btn btn-default btn-sm pull-right" href="a_list.php?page=<?php echo $a+$pagex; ?>"><?php echo $a+$pagex; ?></a>
<?php
}
...
if($page>5){ 
?>
                  <a class="btn btn-default btn-sm pull-right" href="a_list.php?page=1">First</a>
<?php 
}
?>
                </div>
